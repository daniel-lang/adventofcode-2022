...
int main(int, char *argv[])
{
    ...
    for (int i = 0; i < 10000; ++i)
    {
        ...
        for (auto &monkey : monkeys)
        {
            ...
            {
                monkey.inspections++;
                uint64_t item = monkey.items[j];
                uint64_t number = item;
                ...
                if (item % monkey.test == 0)
                {
                    ...
                    if (monkey.idTestTrue == 2)
                        std::cout << j << ": " << monkey.items[j] << " -> " << item << " to " << monkey.idTestTrue << "\n";
                }
                else
                {
